...
TEST(HanoiTowersOpt_CPU, ClassicBFS_10) {
    FourPegHanoiOptimized puzzle(10);
    PuzzleOptions opts;
    opts.segmentBits = 32;
    opts.threads = 1;
    auto result = DiskBasedClassicBFS(puzzle, puzzle.ToString(0), opts);
...
TEST(HanoiTowersOpt_CPU, OptFS_10_mt) {
    FourPegHanoiOptimized puzzle(10);
    PuzzleOptions opts;
    opts.segmentBits = 20;
    opts.threads = 4;
...
TEST(HanoiTowersOpt_CPU, ClassicBFS_10_Sym) {
    FourPegHanoiOptimized puzzle(10, true);
    PuzzleOptions opts;
    opts.segmentBits = 32;
    opts.threads = 1;
    auto result = DiskBasedClassicBFS(puzzle, puzzle.ToString(0), opts);
...
TEST(HanoiTowersOpt_CPU, OptFS_10_mt_Sym) {
    FourPegHanoiOptimized puzzle(10, true);
    PuzzleOptions opts;
    opts.segmentBits = 20;
    opts.threads = 4;
...
TEST(HanoiTowersOpt_CPU, Opt3BitBFS_10_mt_Sym) {
    FourPegHanoiOptimized puzzle(10, true);
    PuzzleOptions opts;
    opts.segmentBits = 20;
    opts.threads = 4;
...
TEST(HanoiTowersOpt_GPU, ClassicBFS_10_Sym) {
    FourPegHanoiOptimizedGPU puzzle(10, true);
    PuzzleOptions opts;
    opts.segmentBits = 32;
    opts.threads = 1;
    auto result = DiskBasedClassicBFS(puzzle, puzzle.ToString(0), opts);
...
TEST(HanoiTowersOpt_GPU, OptFS_10_mt_Sym) {
    FourPegHanoiOptimizedGPU puzzle(10, true);
    PuzzleOptions opts;
    opts.segmentBits = 20;
    opts.threads = 4;
...
TEST(HanoiTowersOpt_GPU, Opt3BitBFS_10_mt_Sym) {
    FourPegHanoiOptimizedGPU puzzle(10, true);
    PuzzleOptions opts;
    opts.segmentBits = 20;
    opts.threads = 4;
...
TEST(HanoiTowersOpt_GPU, Opt3BitBFS_21) {
    FourPegHanoiOptimizedGPU puzzle(21, false);
    PuzzleOptions opts;
    opts.segmentBits = 32;
    opts.threads = 2;
    opts.maxSteps = 10;
...
TEST(HanoiTowersOpt_GPU, Opt3BitBFS_21_Sym) {
    FourPegHanoiOptimizedGPU puzzle(21, true);
    PuzzleOptions opts;
    opts.segmentBits = 32;
    opts.threads = 2;
    opts.maxSteps = 10;
